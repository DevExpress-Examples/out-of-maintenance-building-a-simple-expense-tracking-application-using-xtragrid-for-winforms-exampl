...
Namespace XtraGridTutorial
	Partial Public Class MainForm
		...
		Private Sub InitializeComponent()
			...
			Me.colAmount.OptionsColumn.AllowGroup = DevExpress.Utils.DefaultBoolean.False
			Me.colAmount.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() { New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Amount", "Total: {0:c}")})
			...
			styleFormatCondition1.Appearance.BackColor = System.Drawing.Color.LightPink
			styleFormatCondition1.Appearance.Options.UseBackColor = True
			styleFormatCondition1.ApplyToRow = True
			styleFormatCondition1.Column = Me.colAmount
			styleFormatCondition1.Condition = DevExpress.XtraGrid.FormatConditionEnum.GreaterOrEqual
			styleFormatCondition1.Value1 = 600
			styleFormatCondition2.Appearance.BackColor = System.Drawing.Color.LightPink
			styleFormatCondition2.Appearance.Options.UseBackColor = True
			styleFormatCondition2.ApplyToRow = True
			styleFormatCondition2.Column = Me.colAmount
			styleFormatCondition2.Condition = DevExpress.XtraGrid.FormatConditionEnum.LessOrEqual
			styleFormatCondition2.Value1 = "-600"
			Me.transactionsGridView.FormatConditions.AddRange(New DevExpress.XtraGrid.StyleFormatCondition() { styleFormatCondition1, styleFormatCondition2})
			Me.transactionsGridView.GridControl = Me.transactionsGridControl
			Me.transactionsGridView.GroupCount = 1
			Me.transactionsGridView.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() { New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "ID", Nothing, "(Transaction count: {0})"), New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Amount", Me.colAmount, "Total: {0:c}")})
			...
			Me.transactionsGridView.OptionsView.ShowFooter = True
			Me.transactionsGridView.SortInfo.AddRange(New DevExpress.XtraGrid.Columns.GridColumnSortInfo() { New DevExpress.XtraGrid.Columns.GridColumnSortInfo(Me.colTrasactionDate, DevExpress.Data.ColumnSortOrder.Ascending)})
'			Me.transactionsGridView.InvalidRowException += New DevExpress.XtraGrid.Views.Base.InvalidRowExceptionEventHandler(Me.transactionsGridView_InvalidRowException);
'			Me.transactionsGridView.ValidateRow += New DevExpress.XtraGrid.Views.Base.ValidateRowEventHandler(Me.transactionsGridView_ValidateRow);
			' 
			' colID
			' 
			...
			Me.colAccount.FilterMode = DevExpress.XtraGrid.ColumnFilterMode.DisplayText
			Me.colAccount.Name = "colAccount"
			Me.colAccount.OptionsFilter.FilterPopupMode = DevExpress.XtraGrid.Columns.FilterPopupMode.CheckedList
			...
			Me.colCategory.FilterMode = DevExpress.XtraGrid.ColumnFilterMode.DisplayText
			...
			Me.colTrasactionDate.GroupInterval = DevExpress.XtraGrid.ColumnGroupInterval.DateMonth
			...
			Me.colComment.OptionsColumn.AllowGroup = DevExpress.Utils.DefaultBoolean.False
			...
			Me.xtraTabPage2.Size = New System.Drawing.Size(635, 414)
			...
			Me.accountsGridControl.Size = New System.Drawing.Size(635, 414)
			...
			Me.accountsGridView.OptionsCustomization.AllowGroup = False
			Me.accountsGridView.OptionsView.ShowGroupPanel = False
			' 
			' colID1
			' 
			...
			Me.xtraTabPage3.Size = New System.Drawing.Size(635, 414)
			...
			Me.categoriesGridControl.Size = New System.Drawing.Size(635, 414)
			...
			Me.categoriesGridView.OptionsCustomization.AllowGroup = False
			Me.categoriesGridView.OptionsView.ShowGroupPanel = False
			' 
			' colID2
			' 
			...
			Me.barManager1.Items.AddRange(New DevExpress.XtraBars.BarItem() { Me.barButtonSave, Me.barButtonReload, Me.barButtonItem1})
			...
			Me.bar2.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() { New DevExpress.XtraBars.LinkPersistInfo(Me.barButtonSave), New DevExpress.XtraBars.LinkPersistInfo(Me.barButtonReload), New DevExpress.XtraBars.LinkPersistInfo(Me.barButtonItem1)})
...
'			Me.barButtonReload.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonReload_ItemClick);
			...
			' barButtonItem1
			' 
			Me.barButtonItem1.Caption = "Print Preview"
