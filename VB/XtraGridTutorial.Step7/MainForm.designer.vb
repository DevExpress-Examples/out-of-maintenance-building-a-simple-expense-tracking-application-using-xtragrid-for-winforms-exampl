Namespace XtraGridTutorial
    Partial Public Class MainForm
        ...
        Private Sub InitializeComponent()
            ...
            Me.transactionsGridView.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() { _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "ID", Nothing, "(Transaction count: {0})"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Amount", Me.colAmount, "Total: {0:c}") _
            })
